  ...
  describe('getColorChannels', () => {
    it('should extract numeric channel values from a color object', () => {
      ...
      const mockColor = {
        ...
        dynamicRange: 'SDR',
        channels: {
          r: { name: 'red', min: 0, max: 1 } as unknown as ColorChannel,
          g: { name: 'green', min: 0, max: 1 } as unknown as ColorChannel,
          b: { name: 'blue', min: 0, max: 1 } as unknown as ColorChannel
        },
        r: 0.5,
        g: 0.6,
        b: 0.7,
    ...
    it('should skip non-numeric properties', () => {
      ...
      const mockColor = {
        ...
        channels: {
          r: { name: 'red', min: 0, max: 1 } as unknown as ColorChannel,
          g: { name: 'green', min: 0, max: 1 } as unknown as ColorChannel,
          nonNumeric: { name: 'nonNumeric', min: 0, max: 1 } as unknown as ColorChannel
        },
        r: 0.5,
        g: 0.6,
    ...
    it('should handle color objects with no numeric channels', () => {
      ...
      const mockColor = {
        ...
        dynamicRange: 'SDR',
        channels: {
          nonNumeric1: { name: 'nonNumeric1', min: 0, max: 1 } as unknown as ColorChannel,
          nonNumeric2: { name: 'nonNumeric2', min: 0, max: 1 } as unknown as ColorChannel
        },
